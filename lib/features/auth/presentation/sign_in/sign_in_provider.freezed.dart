...
mixin _$SignInState {
 ...
 String get phoneNumber; bool get isLoading; bool get isSuccess;// 인증번호 전송 성공 여부
 String? get verificationId; String? get errorMessage;
...
@override
int get hashCode => Object.hash(runtimeType,phoneNumber,isLoading,isSuccess,verificationId,errorMessage);
...
@useResult
$Res call({
 String phoneNumber, bool isLoading, bool isSuccess, String? verificationId, String? errorMessage
});
...
/// Create a copy of SignInState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? phoneNumber = null,Object? isLoading = null,Object? isSuccess = null,Object? verificationId = freezed,Object? errorMessage = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String phoneNumber,  bool isLoading,  bool isSuccess,  String? verificationId,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SignInState() when $default != null:
return $default(_that.phoneNumber,_that.isLoading,_that.isSuccess,_that.verificationId,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String phoneNumber,  bool isLoading,  bool isSuccess,  String? verificationId,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _SignInState():
return $default(_that.phoneNumber,_that.isLoading,_that.isSuccess,_that.verificationId,_that.errorMessage);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String phoneNumber,  bool isLoading,  bool isSuccess,  String? verificationId,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _SignInState() when $default != null:
return $default(_that.phoneNumber,_that.isLoading,_that.isSuccess,_that.verificationId,_that.errorMessage);case _:
  return null;
...
class _SignInState extends SignInState {
  const _SignInState({this.phoneNumber = '', this.isLoading = false, this.isSuccess = false, this.verificationId, this.errorMessage}): super._();
...
/// Create a copy of SignInState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? phoneNumber = null,Object? isLoading = null,Object? isSuccess = null,Object? verificationId = freezed,Object? errorMessage = freezed,}) {
