...
mixin _$HomeState {
  ...
  @override
  String toString() {
    return 'HomeState(selectedFilter: $selectedFilter)';
  }
}
...
abstract mixin class $HomeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({PostFilter selectedFilter});
}
...
extension HomeStatePatterns on HomeState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(PostFilter selectedFilter)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _HomeState() when $default != null:
        return $default(_that.selectedFilter);
      case _:
        return orElse();
    }
  }
...
class _HomeState extends HomeState {
  const _HomeState({this.selectedFilter = PostFilter.all}) : super._();
