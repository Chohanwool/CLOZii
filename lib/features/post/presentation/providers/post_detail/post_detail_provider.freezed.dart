...
mixin _$PostDetailState {
 ...
 bool get isExpanded; double get stretchOffset;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PostDetailState&&(identical(other.isExpanded, isExpanded) || other.isExpanded == isExpanded)&&(identical(other.stretchOffset, stretchOffset) || other.stretchOffset == stretchOffset));
}
...
@useResult
$Res call({
 bool isExpanded, double stretchOffset
});
...
/// Create a copy of PostDetailState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isExpanded = null,Object? stretchOffset = null,}) {
  return _then(_self.copyWith(
isExpanded: null == isExpanded ? _self.isExpanded : isExpanded // ignore: cast_nullable_to_non_nullable
as bool,stretchOffset: null == stretchOffset ? _self.stretchOffset : stretchOffset // ignore: cast_nullable_to_non_nullable
as double,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isExpanded,  double stretchOffset)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PostDetailState() when $default != null:
return $default(_that.isExpanded,_that.stretchOffset);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isExpanded,  double stretchOffset)  $default,) {final _that = this;
switch (_that) {
case _PostDetailState():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isExpanded,  double stretchOffset)?  $default,) {final _that = this;
switch (_that) {
case _PostDetailState() when $default != null:
return $default(_that.isExpanded,_that.stretchOffset);case _:
  return null;
...
class _PostDetailState extends PostDetailState {
  const _PostDetailState({this.isExpanded = true, this.stretchOffset = 0.0}): super._();
  

@override@JsonKey() final  bool isExpanded;
@override@JsonKey() final  double stretchOffset;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PostDetailState&&(identical(other.isExpanded, isExpanded) || other.isExpanded == isExpanded)&&(identical(other.stretchOffset, stretchOffset) || other.stretchOffset == stretchOffset));
}
...
/// Create a copy of PostDetailState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isExpanded = null,Object? stretchOffset = null,}) {
