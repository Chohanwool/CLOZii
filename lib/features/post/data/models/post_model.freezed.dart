...
mixin _$PostModel {
  ...
  String get title;
  String get content;
  List<String> get originImageUrls; // Firebase Storage URLs
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.originImageUrls, originImageUrls) &&
            const DeepCollectionEquality()
                .equals(other.thumbnailImageUrls, thumbnailImageUrls) &&
    ...
    return _then(_self.copyWith(
      ...
      content: null == content
          ...
          : content // ignore: cast_nullable_to_non_nullable
              as String,
      originImageUrls: null == originImageUrls
          ? _self.originImageUrls
          : originImageUrls // ignore: cast_nullable_to_non_nullable
              as List<String>,
      thumbnailImageUrls: null == thumbnailImageUrls
          ? _self.thumbnailImageUrls
    ...
    switch (_that) {
      case _PostModel() when $default != null:
        return $default(
            ...
            _that.title,
            _that.content,
            _that.originImageUrls,
            _that.thumbnailImageUrls,
            _that.price,
            _that.tradeType,
            _that.postStatus,
            _that.category,
...
class _PostModel extends PostModel {
  _PostModel(
      ...
      required final List<String> originImageUrls,
  ...
  @override
  List<String> get originImageUrls {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.content, content) || other.content == content) &&
            const DeepCollectionEquality()
                .equals(other._originImageUrls, _originImageUrls) &&
            const DeepCollectionEquality()
    ...
    return _then(_PostModel(
      ...
      content: null == content
          ...
          : content // ignore: cast_nullable_to_non_nullable
              as String,
      originImageUrls: null == originImageUrls
          ? _self._originImageUrls
          : originImageUrls // ignore: cast_nullable_to_non_nullable
              as List<String>,
      thumbnailImageUrls: null == thumbnailImageUrls
          ? _self._thumbnailImageUrls
          : thumbnailImageUrls // ignore: cast_nullable_to_non_nullable
              as List<String>,
      price: null == price
          ? _self.price
